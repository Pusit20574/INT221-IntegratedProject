<template>
  <p class="font-medium text-lg md:text-2xl lg:text-3xl pt-20">Trending CaseCoolors!</p>
  <p class="font-normal text-lg md:text-2xl lg:text-3xl text-md leading-3">Take these babies home with you</p>
